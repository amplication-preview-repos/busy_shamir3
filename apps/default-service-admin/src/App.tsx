...
import { IdentityProviderCreate } from "./identityProvider/IdentityProviderCreate";
import { IdentityProviderEdit } from "./identityProvider/IdentityProviderEdit";
import { IdentityProviderShow } from "./identityProvider/IdentityProviderShow";
      ...
      <BrowserRouter>
        ...
        >
          <Resource
            ...
            edit={IdentityProviderEdit}
            create={IdentityProviderCreate}
            show={IdentityProviderShow}
          />
          <Resource
            name="User"
            list={UserList}
